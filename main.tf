terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "taskboardsgtodorbelchev"
...
provider "azurerm" {
  subscription_id = "5797d347-9559-476b-8160-775f0481db12"
  features {}
}
...
resource "azurerm_app_service_source_control" "aassc" {
  ...
  repo_url               = "https://github.com/TodorBelchev/Softuni-Taskboard-Terraform"
  branch                 = "main"
